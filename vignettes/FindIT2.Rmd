...
解释下
when you have
- select peak (from Kmeans, diff analysis and so on)
- peak_GR(ATAC/H3K27me3 GRange with feature_id column)
- TF_GR_database(can from public TF database or motif scan in ATAC/H3K27me3 data,
it have TF_id column)
- powerful computer(shuffle will be slow if not using multi-threads)
...
# add TF_GR_database from Remap2020
...
# please pay attention that it do not work in only several TF and several promoter
# which you can see
set.seed(20160806)
